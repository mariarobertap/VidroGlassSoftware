...
def start():
    ...
    page_layout.add(Paragraph("VIDROGLASS VIDRAÇARIA", font_size = 20, horizontal_alignment=Alignment.CENTERED, font_color=HexColor("ff0000")))
    page_layout.add(
            Image(
            "https://i.imgur.com/UZJjezQ.png",
            width=Decimal(128),
            height=Decimal(100),
            ))
    ...
    with open("..\\invoice\\NotaVidroglass.pdf", "wb") as pdf_file_handle:
        PDF.dumps(pdf_file_handle, pdf)

    print("Invoice criado :]")